...
namespace XiaBags_Ecommerce.Areas.Admin.Controllers
{
    ...
    public class AdminOrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderId,Name,LastName,Address,PostalCode,City,District,PhoneNumber,Email,OrderDate,OrderSentDate")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,Name,LastName,Address,PostalCode,City,District,PhoneNumber,Email,OrderDate,OrderSentDate")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
