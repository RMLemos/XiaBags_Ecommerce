...
namespace XiaBags_Ecommerce.Areas.Admin.Controllers
{
    ...
    public class AdminProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,Name,Description,Price,ImageURL,ImageThumbnailURL,StockInHand,CategoryId,CreatedAt,LastUpdatedAt")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,Name,Description,Price,ImageURL,ImageThumbnailURL,StockInHand,CategoryId,CreatedAt,LastUpdatedAt")] Product product)
        {
